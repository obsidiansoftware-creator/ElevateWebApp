        ...
        <div className="relative flex min-h-screen bg-tech text-cyan-100 overflow-hidden">
          ...
          >            <div className="flex items-center justify-between mb-8">
            ...
            <nav className="space-y-3 text-sm">
              <button
                onClick={() => navigate('/dashboardCliente/principal')}
                className="nav-btn"
              >
                ▸ Principal
              </button>
              ...
              <button
                onClick={() => navigate('/dashboardCliente/proyectos')}
                className="nav-btn"
              >
                ▸ Proyectos
              </button>
              ...
              <button
                onClick={() => navigate('/dashboardCliente/proyectos/calendario')}
                className="nav-btn"
              >
                ▸ Calendario
              </button>
              ...
              <button
                onClick={() => navigate('/dashboardCliente/proveedores')}
                className="nav-btn"
              >
                ▸ Provedores
              </button>
              ...
              <button
                onClick={() => navigate('/dashboardCliente/clientes')}
                className="nav-btn"
              >
                ▸ Clientes
              </button>
              ...
              <button
                onClick={() => navigate('/dashboardCliente/elevadores')}
                className="nav-btn"
              >
                ▸ Elevadores
              </button>
              ...
              <button
                onClick={() => navigate('/dashboardCliente/mantenimientos')}
                className="nav-btn"
              >
                ▸ Mantenimientos
              </button>
