...
import { useProyectos, Proyecto } from '@/app/dashboardCliente/contexts/ProyectosContext'
import ProyectoForm from '@/app/dashboardCliente/proyectos/proyectos/ProyectForm'
...
>('TODOS')
  ...
  const handleDelete = async (id: number) => {
    ...
    const res = await fetch('/apiCliente/proyectos', {
      method: 'DELETE',
      credentials: 'include',
